...
public class CreateRental extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CreateRental frame = new CreateRental();
	...
	public CreateRental() {
		...
		button.setBounds(27, 25, 105, 22);
		contentPane.add(button);
		
		Button button_1 = new Button("S\u00F8g Beboer");
		button_1.setBounds(141, 25, 105, 22);
		contentPane.add(button_1);
		
		Button button_2 = new Button("Opret Udl\u00E5n");
		button_2.setBounds(27, 53, 219, 22);
		...
		button_4.setBounds(454, 432, 99, 22);
		contentPane.add(button_4);
		
		Button button_5 = new Button("Annuller udlejning");
		button_5.setBounds(596, 471, 105, 22);
		contentPane.add(button_5);
		
		Button button_6 = new Button("Gem Udlejning");
		button_6.setBounds(728, 471, 105, 22);
