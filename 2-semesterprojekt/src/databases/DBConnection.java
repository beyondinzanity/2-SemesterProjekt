...
public class DBConnection {
	...
	private static final String dbName = "GuldBoSund";
...
//				serverAddress, serverPort, dbName, userName, password);
		String connectionString2 = String.format("jdbc:sqlserver://%s:%d;databaseName=%s;user=%s;password=%s;",
				serverAddress, serverPort, dbName, userName, password); // TEST MÅ GERNE SLETTES!
		try {
